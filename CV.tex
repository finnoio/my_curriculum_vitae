...
\begin{itemize}
    \item Антем лох With my previous QA experience I started with data quality activities, as I developed testing framework from scratch and ran prod-like testing environment. Python+ Pytest.
